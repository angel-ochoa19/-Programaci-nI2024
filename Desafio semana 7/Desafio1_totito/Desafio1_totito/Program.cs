...
namespace TresEnLinea
{
    class Program
    {
        ...
        static void MostrarInstrucciones()
        {
            ...
            Console.WriteLine("1 | | | |");
            Console.WriteLine("2 | | | |");
            Console.WriteLine("1.Elige una fila (0-2) y una columna (0-2) para colocar tu ficha (‘X’ o ‘O’).");
            Console.WriteLine("2.Elige una fila (0-2) y una columna (0-2) para colocar tu ficha (‘X’ o ‘O’).");
            Console.WriteLine("3.¡Diviértete jugando ToTiTo!");
